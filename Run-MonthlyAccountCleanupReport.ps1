...
Select-Object GivenName, Surname, SamAccountname, Description, EmployeeID | 
ConvertTo-Html
Send-MailMessage -To "ruben_reyes@ezcorp.com" -From "monthlycleanupnotice@ezcorp.com" -Subject "Monthly Account Cleanup Notice" 
